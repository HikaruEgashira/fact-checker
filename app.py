...
def main() -> None:
    ...
    submit_parser = subparsers.add_parser('submit', help='Submit a fact-checking request')
    submit_parser.add_argument('--text', required=True, help='The text to be fact-checked')
    
    status_parser = subparsers.add_parser('status', help='Check the status of a fact-checking task')
